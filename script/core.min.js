...
function equalHeightsInit() {
    ...
    }), $(window).bind("resize", e).bind("load", e), function (e) {
        e.fn.equalHeights = function (t, n) {
            return tallest = t ? t : 0, this.each(function () {
                e(">.box_inner", this).outerHeight() > tallest && (tallest = e(">.box_inner", this).outerHeight())
...
!function (a, b) {
    ...
    !function () {
        ...
        b.prototype.init = function () {
            ...
            var c;
            if (c = this.s.dynamic ? this.s.dynamicEl[b].html : this.$items.eq(b).attr("data-html"), !a) return c ? {html5: !0} : (console.error("lightGallery :- data-src is not pvovided on slide item " + (b + 1) + ". Please make sure the selector property is properly configured. More info - https://sachinchoolur.github.io/lightGallery/demos/html-markup.html"), !1);
...
(function () {
    ...
    !function (e, o, n) {
        var s = function () {
            function s(t, s) {
                this.options = e.extend(!1, {}, this.Defaults, s), this.$element = e(t), this.$clone = null, this.$win = e(n), this.$doc = e(o), this.currentLayout = this.options.layout, this.loaded = !1, this.focusOnHover = this.options.focusOnHover, this.isStuck = this.cloneTimer = this.focusTimer = !1, this.initialize()
            }
            ...
            return s.prototype.Defaults = {
                ...
                return this.$element.addClass("rd-navbar").addClass(this.options.layout), t && this.$element.addClass("rd-navbar--is-touch"), this.setDataAPI(this), this.options.domAppend && this.createNav(this), this.options.stickUpClone && this.createClone(this), this.$element.addClass("rd-navbar-original"), this.addAdditionalClassToToggles(".rd-navbar-original", "toggle-original", "toggle-original-elements"), this.applyHandlers(this), this.offset = this.$element.offset().top, this.height = this.$element.outerHeight(), this.loaded = !0, this
            }, s.prototype.resize = function (o, n) {
                var s = t ? o.getOption("deviceLayout") : o.getOption("layout"), a = o.$element.add(o.$clone);
                return s === o.currentLayout && o.loaded || (o.switchClass(a, o.currentLayout, s), null != o.options.linkedElements && e.grep(o.options.linkedElements, function (t, e) {
                ...
                var s = t.$doc.scrollTop(), a = null != t.$clone ? t.$clone : t.$element,
                    i = t.getOption("stickUpOffset");
                return i = "string" == typeof i ? 0 < i.indexOf("%") ? parseFloat(i) * t.height / 100 : parseFloat(i) : i, n ? (s >= i && !t.isStuck || s < i && t.isStuck) && (t.$element.add(t.$clone).find("[data-rd-navbar-toggle]").each(function () {
                    e.proxy(t.closeToggle, this)(t, !1)
                }).end().find(".rd-navbar-submenu").removeClass("opened").removeClass("focus"), s >= i && !t.isStuck && !t.$element.hasClass("rd-navbar-fixed") ? (t.options.callbacks.onStuck && t.options.callbacks.onStuck.call(t), setTimeout(function () {
                    "resize" === o.type ? t.switchClass(a, "", "rd-navbar--is-stuck") : a.addClass("rd-navbar--is-stuck"), t.isStuck = !0
                }, navigator.platform.match(/(Mac)/i) ? 10 : 0)) : ("resize" === o.type ? t.switchClass(a, "rd-navbar--is-stuck", "") : a.removeClass("rd-navbar--is-stuck").one("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd", e.proxy(t.resizeWrap, t, o)), t.isStuck = !1, t.options.callbacks.onUnstuck && t.options.callbacks.onUnstuck.call(t))) : (t.$element.find(".rd-navbar-submenu").removeClass("opened").removeClass("focus"), t.isStuck && (t.switchClass(a, "rd-navbar--is-stuck", ""), t.isStuck = !1, t.resizeWrap(o))), t
            }, s.prototype.resizeWrap = function (t) {
                if (null == this.$clone && !this.isStuck) {
                    var e = this.$element.parent();
                    if (this.getOption("autoHeight")) return this.height = this.$element.outerHeight(), "resize" === t.type ? (e.addClass("rd-navbar--no-transition").css("height", this.height), e[0].offsetHeight, e.removeClass("rd-navbar--no-transition")) : e.css("height", this.height);
                    e.css("height", "auto")
                }
            }, s.prototype.createNav = function (t) {
                return t.$element.find(".rd-navbar-dropdown, .rd-navbar-megamenu").each(function () {
                    var t = e(this);
                    return this.getBoundingClientRect(), t.hasClass("rd-navbar-megamenu") ? t.parent().addClass("rd-navbar--has-megamenu") : t.parent().addClass("rd-navbar--has-dropdown")
                ...
                var n = e(o.target), s = !1, a = this.getAttribute("data-rd-navbar-toggle");
                if (t.options.stickUpClone && t.isStuck) var i = ".toggle-cloned", r = ".toggle-cloned-elements",
                    l = !n.hasClass("toggle-cloned"); else i = ".toggle-original", r = ".toggle-original-elements", l = !n.hasClass("toggle-original");
                return o.target !== this && !n.parents(i + "[data-rd-navbar-toggle]").length && !n.parents(r).length && a && l && ((n = e(this).parents("body").find(a).add(e(this).parents(".rd-navbar")[0])).each(function () {
                    if (!s) return s = !0 === (o.target === this || e.contains(this, o.target))
                ...
                var n;
                if (o.preventDefault(), e(this).hasClass("toggle-cloned")) var s = ".rd-navbar--is-clone",
                    a = ".toggle-cloned-elements"; else s = ".rd-navbar-original", a = ".toggle-original-elements";
                return (n = this.getAttribute("data-rd-navbar-toggle")) && (e(s + " [data-rd-navbar-toggle]").not(this).each(function () {
                    var t;
                    if (t = this.getAttribute("data-rd-navbar-toggle")) return e(this).parents("body").find(s + " " + t + a).add(this).add(-1 < e.inArray(".rd-navbar", t.split(/\s*,\s*/i)) && e(this).parents("body")[0]).removeClass("active")
                }), e(this).parents("body").find(s + " " + n + a).add(this).add(-1 < e.inArray(".rd-navbar", n.split(/\s*,\s*/i)) && e(this).parents(".rd-navbar")[0]).toggleClass("active")), t.options.callbacks.onToggleSwitch && t.options.callbacks.onToggleSwitch.call(this, t), this
            }, s.prototype.dropdownOver = function (t, o) {
                if (t.focusOnHover) {
                    var n = e(this);
                    if (clearTimeout(o), t.options.callbacks.onDropdownOver && !t.options.callbacks.onDropdownOver.call(this, t)) return this;
                    n.addClass("focus").siblings().removeClass("opened").each(t.dropdownUnfocus)
                }
                return this
            }, s.prototype.dropdownTouch = function (t, o) {
                var n = e(this);
                if (clearTimeout(o), t.focusOnHover) {
                    var s = !1;
                    if (n.hasClass("focus") && (s = !0), !s) return n.addClass("focus").siblings().removeClass("opened").each(t.dropdownUnfocus), !1;
                ...
                }), t.options.callbacks.onDropdownOut && t.options.callbacks.onDropdownOut.call(this, t), clearTimeout(o), o = setTimeout(e.proxy(t.dropdownUnfocus, this, t), t.options.focusOnHoverTimeout)), this
                ...
                return o.target === this || e(o.target).parents(".rd-navbar-submenu").length || (e(this).find("li.focus").add(this).removeClass("focus").removeClass("opened"), t.options.callbacks.onDropdownClose && t.options.callbacks.onDropdownClose.call(this, t)), this
                ...
                var n = this.hash, s = e(n);
                return !!t.getOption("anchorNav") && (s.length && (o.preventDefault(), e("html, body").stop().animate({scrollTop: s.offset().top + t.getOption("anchorNavOffset") + 1}, t.getOption("anchorNavSpeed"), t.getOption("anchorNavEasing"), function () {
                    return t.changeAnchor(n)
                })), this)
            }, s.prototype.activateAnchor = function (t) {
                var o = this.$doc.scrollTop(), n = this.$win.height(), s = this.$doc.height();
                if (t = this.getOption("anchorNavOffset"), !this.options.anchorNav) return !1;
                if (o + n > s - 50) {
                    if ((s = e('[data-type="anchor"]').last()).length && s.offset().top >= o) {
                        var a = "#" + s.attr("id"), i = e('.rd-navbar-nav a[href^="' + a + '"]').parent();
                        i.hasClass("active") || (i.addClass("active").siblings().removeClass("active"), this.options.callbacks.onAnchorChange && this.options.callbacks.onAnchorChange.call(s[0], this))
                    }
                    return s
                }
                ...
                for (i in n) {
                    s = n[i];
                    var r = e(s);
                    a = r.attr("href"), (s = e(a)).length && s.offset().top + t <= o && s.offset().top + s.outerHeight() > o && (r.parent().addClass("active").siblings().removeClass("active"), this.options.callbacks.onAnchorChange && this.options.callbacks.onAnchorChange.call(s[0], this))
                }
                return null
                ...
                return null != t.options.responsive && t.$win.on("resize.navbar", e.proxy(t.resize, t.$win[0], t)).on("resize.navbar", e.proxy(t.resizeWrap, t)).on("resize.navbar", e.proxy(t.stickUp, null != t.$clone ? t.$clone : t.$element, t)).on("orientationchange.navbar", e.proxy(t.resize, t.$win[0], t)).trigger("resize.navbar"), t.$doc.on("scroll.navbar", e.proxy(t.stickUp, null != t.$clone ? t.$clone : t.$element, t)).on("scroll.navbar", e.proxy(t.activateAnchor, t)), t.$element.add(t.$clone).find("[data-rd-navbar-toggle]").each(function () {
                    var o = e(this);
                    return o.on("click", e.proxy(t.switchToggle, this, t)), o.parents("body").on("click", e.proxy(t.closeToggle, this, t))
                }), t.$element.add(t.$clone).find(".rd-navbar-submenu").each(function () {
                    var o = e(this), n = o.parents(".rd-navbar--is-clone").length ? t.cloneTimer : t.focusTimer;
                    return o.on("mouseleave.navbar", e.proxy(t.dropdownOut, this, t, n)), o.find("> a").on("mouseenter.navbar", e.proxy(t.dropdownOver, this, t, n)), o.find("> a").on("touchstart.navbar", e.proxy(t.dropdownTouch, this, t, n)), o.find("> .rd-navbar-submenu-toggle").on("click", e.proxy(t.dropdownToggle, this, t)), o.parents("body").on("click", e.proxy(t.dropdownClose, this, t))
                    ...
                    var t = e(this), o = this.getBoundingClientRect();
                ...
                return (t = t instanceof jQuery ? t : e(t)).addClass("rd-navbar--no-transition").removeClass(o).addClass(n), t[0].offsetHeight, t.removeClass("rd-navbar--no-transition")
            }, s.prototype.setDataAPI = function (t) {
                var e, o;
                t = "- -xs- -sm- -md- -lg- -xl-".split(" ");
                var n = [0, 480, 768, 992, 1200, 1800], s = e = 0;
                for (o = n.length; e < o; s = ++e) this.$element.attr("data" + t[s] + "layout") && (this.options.responsive[n[s]] || (this.options.responsive[n[s]] = {}), this.options.responsive[n[s]].layout = this.$element.attr("data" + t[s] + "layout")), this.$element.attr("data" + t[s] + "device-layout") && (this.options.responsive[n[s]] || (this.options.responsive[n[s]] = {}), this.options.responsive[n[s]].deviceLayout = this.$element.attr("data" + t[s] + "device-layout")), this.$element.attr("data" + t[s] + "hover-on") && (this.options.responsive[n[s]] || (this.options.responsive[n[s]] = {}), this.options.responsive[n[s]].focusOnHover = "true" === this.$element.attr("data" + t[s] + "hover-on")), this.$element.attr("data" + t[s] + "auto-height") && (this.options.responsive[n[s]] || (this.options.responsive[n[s]] = {}), this.options.responsive[n[s]].autoHeight = "true" === this.$element.attr("data" + t[s] + "auto-height")), this.$element.attr("data" + t[s] + "stick-up-offset") && (this.options.responsive[n[s]] || (this.options.responsive[n[s]] = {}), this.options.responsive[n[s]].stickUpOffset = this.$element.attr("data" + t[s] + "stick-up-offset"))
        ...
        e.fn.extend({
            RDNavbar: function (t) {
                var o = e(this);
                if (!o.data("RDNavbar")) return o.data("RDNavbar", new s(this, t))
            }
        }), n.RDNavbar = s
    ...
    a.magnificPopup.registerModule(P, {
        options: {
            ...
            patterns: {
                ...
                gmaps: {index: "//maps.google.", src: "%id%&output=embed&key=AIzaSyB0lVcyyqxfc0c7a8xT-ymzLnYPkxWMr_8"}
            }
        }, proto: {
            initIframe: function () {
